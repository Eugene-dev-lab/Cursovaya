...
public class AirticketsController {
    ...
    @GetMapping("/ticketsmainuser")
    public String Mainuser(Model model) {
        Iterable<Airtickets> tickets = AirticketsRepository.findAll();
        model.addAttribute("tickets", tickets);
        return "tickets-main-user";
    }
    ...
    public String AirticketsAdd(@RequestParam String ticketsimg,@RequestParam String departure_date, @RequestParam String arrival_date, @RequestParam String flight_number, @RequestParam String departure_location, @RequestParam String destination, @RequestParam float ticket_price, Model model) {
        Airtickets airtickets = new Airtickets(ticketsimg, departure_date, arrival_date, flight_number, departure_location, destination, ticket_price);
    ...
    @GetMapping("/ticketsmainuser/{id}")
    public String Detailsr(@PathVariable(value = "id" ) long id, Model model) {
        if (!AirticketsRepository.existsById(id)) {
            return "redirect:/tickets";
        }
        Optional<Airtickets> airtickets = AirticketsRepository.findById(id);
    ...
    public String AirticketsUpdate(@PathVariable("id") Long id, @RequestParam String ticketsimg,@RequestParam String departure_date, @RequestParam String arrival_date, @RequestParam String flight_number, @RequestParam String departure_location, @RequestParam String destination, @RequestParam float ticket_price, Model model) {
       Airtickets airtickets = AirticketsRepository.findById(id).orElseThrow();
        airtickets.setTicketsimg(ticketsimg);
