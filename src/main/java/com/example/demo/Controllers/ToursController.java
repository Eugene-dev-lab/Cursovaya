...
public class ToursController {
    ...
    @GetMapping("/toursmainuser")
    public String Toursuser(Model model) {
        Iterable<Tours> tours = ToursRepository.findAll();
        model.addAttribute("tours", tours );
        return "tours-main-user";
    }
    ...
    public String ToursAdd(@RequestParam String image, @RequestParam String start_date, @RequestParam String end_date, @RequestParam String destination, @RequestParam String tour_price, Model model) {
        Tours tours = new Tours(image, start_date, end_date, destination, tour_price);
    ...
    public String ToursUpdate(@PathVariable("id") Long id, @RequestParam String image, @RequestParam String start_date, @RequestParam String end_date, @RequestParam String destination, @RequestParam String tour_price,Model model) {
        Tours tours = ToursRepository.findById(id).orElseThrow();
        tours.setImage(image);
